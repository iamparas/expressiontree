...
public class Interpreter {
     ...
     * create the appropriate subclass of @a Component.
     */
    ...
    abstract class Symbol {
        ...
        /** Abstract method for building a @a Component. */
    ...
    class Negate extends UnaryOperator {
        ...
        Component build() {
            return new NegateOperatorNode(right.build());
        }
    ...
    class Add extends Operator {
        ...
        Component build() {
            return new AddOperatorNode(left.build(),
                                        right.build());
        }
    ...
    class Subtract extends Operator {
        ...
        Component build() {
            return new SubtractOperatorNode(left.build(),
                                             right.build());
        }
    ...
    class Multiply extends Operator {
        ...
        Component build() {
            return new MultiplicationOperatorNode(left.build(),
                                             right.build());
        }
    ...
    class Divide extends Operator {
        ...
        Component build() {
            return new DivisonOperatorNode(left.build(),
                                           right.build());
        }
    }
}